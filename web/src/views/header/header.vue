...
@import "//at.alicdn.com/t/c/font_4674494_68ps5ako43u.css";
</style>
	...
	<div class="header-box">
		<div class="header-inner-box">
			<div @click="goHome" title="前往主页面" class="logo-img">
				<div class="logo-name">
					<p class="name-bule">Star<span class="iconfont icon-sijiaoxing"></span>Stream</p>
<!--					<p class="name-ye">Steam</p>-->
					<p class="name-ye-ye">{{nameChar}}</p>
				</div>
			</div>
...
export default {
	...
	methods: {
		...
		goBtn(e){
			// console.log("Button clicked:", e);  // 添加调试输出
			let json= {'where':e}
			this.$emit('go',json);
			this.site=e
		},
